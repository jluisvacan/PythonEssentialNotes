"""
    El cifrado Cesar permite que el valor a se convierte en b, b se convierta en c, z se convierte en a, y así sucesivamente
    Se solicita al usuario una línea de texto para encriptar.
    Se pide al usuario un valor de cambio (un número entero del rango 1..25)
