"""
    El programa crea un objeto datetime con fecha y hora: 4 noviembre de 2020, 14:53:00
    El objeto creado llama al metodo strftime() con el formato apropiado para mostra el siguiente resultado:
        2020/11/04 14:53:00
